...
const UserCard = ({ user, onEdit, onDelete }) => {
  ...
  return (
    <motion.div 
      className="bg-gray-800 angular-cut shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 relative angular-cut"
      initial="rest"
      whileHover="hover"
      animate="rest"
    >
      ...
      <div className="mb-6 space-y-4 md:space-y-0 md:flex md:items-center md:space-x-4">
        <div className="relative flex-grow">
          <input
            ...
            className="w-full px-4 py-4 bg-gray-700 text-white angular-cut pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
