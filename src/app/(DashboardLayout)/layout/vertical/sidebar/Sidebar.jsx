...
import { Settings, Home, Users, ChevronRight, Gamepad2, X, Group, ShieldPlus } from 'lucide-react';
...
const menuItems = [
  ...
  { id: 3, icon: Users, name: 'Users', href: '/dashboards/users' },
  { id: 3, icon: ShieldPlus, name: 'teams', href: '/dashboards/teams' },
