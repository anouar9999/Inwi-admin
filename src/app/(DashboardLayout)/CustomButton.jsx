...
const CustomButton = ({ 
  ...
  const buttonClasses = `
    ...
    text-white font-bold rounded-md text-sm px-6 py-2 
  ...
  const buttonContent = (
    ...
    >
      ...
      <span className="absolute inset-0 bg-gradient-to-r from-transparent via-pink-400 to-transparent opacity-0 group-hover:opacity-20 transform -skew-x-12"></span>
      <style jsx global>{`
        .angular-cut {
          position: relative;
          clip-path: polygon(
